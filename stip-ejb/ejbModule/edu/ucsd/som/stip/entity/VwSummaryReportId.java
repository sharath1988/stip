...
@Embeddable
public class VwSummaryReportId  implements java.io.Serializable {

	private static final long serialVersionUID = -834875545355348543L;
	private String dept;
    ...
    public VwSummaryReportId() {
    }

    public VwSummaryReportId(String dept, String division, String fyQrt, String indx, String fund, String depToIndex, String depToFund, Double amount) {
       this.dept = dept;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof VwSummaryReportId) ) return false;
		 VwSummaryReportId castOther = ( VwSummaryReportId ) other; 
