...
@Entity
@Table(name="stip_dept"
    ,catalog="stip" 
)
public class StipDept  implements java.io.Serializable {

    private static final long serialVersionUID = 6197926239197000894L;
    ...
    public StipDept(String dept, String division, String stipFund, String indx, String fund, String org, String acct, String notes, Boolean status, Date dateCreated, Integer createdBy, Date dateModified, Integer modifiedBy) {
       this.dept = dept;
