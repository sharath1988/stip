...
public class NonSingleJournal  implements java.io.Serializable {

	private static final long serialVersionUID = 6937878446915746851L;

	 private Integer nonSingleJournalId;
    ...
    public NonSingleJournal(Object[] o) {
    	this.nonSingleJournalId=(Integer)o[0];
	...
	public Integer getNonSingleJournalId() {
        return this.nonSingleJournalId;
    }
    
    public void setNonSingleJournalId(Integer nonSingleJournalId) {
        this.nonSingleJournalId = nonSingleJournalId;
    }
